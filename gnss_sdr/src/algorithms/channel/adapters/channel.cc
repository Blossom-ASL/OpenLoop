...
void Channel::connect(gr::top_block_sptr top_block)
{
    ...
    top_block->msg_connect(nav_->get_left_block(), pmt::mp("tow_to_trk"), trk_->get_right_block(), pmt::mp("tow_to_trk"));
...
void Channel::disconnect(gr::top_block_sptr top_block)
{
    ...
    top_block->msg_disconnect(nav_->get_left_block(), pmt::mp("tow_to_trk"), trk_->get_right_block(), pmt::mp("tow_to_trk"));
